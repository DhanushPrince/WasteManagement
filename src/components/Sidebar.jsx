...
import { ALL_ZONES, ZONE_COLORS, ZONE_EMOJI, ZONE_VEHICLE } from "../utils/zones";
import { getUniqueWards } from "../utils/wards";
...
const KNOWN_LOCATIONS = {
  ...
  "RS Puram Market": [11.0040, 76.9535],
  "Singanallur": [11.0030, 77.0321],
  "Coimbatore Airport": [11.0300, 77.0435],
  "PSG College": [11.0232, 77.0010],
